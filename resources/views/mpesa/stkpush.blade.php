        ...
        <div class="roomList">
          <div class="roomListRoom">
            <div class="roomListRoom__content">
              ...
              <form class="form" id="initiatestk" method="POST">
                <div class="form__group">
                  <label for="room_name">Phone Number</label>
                  <input type="number" id="room_name" name="phonenumber" placeholder="0795974284" required/>
                </div>
                <div class="form__group">
                    <label for="room_name">Amount</label>
                    <input type="number" id="room_name" name="amount" placeholder="1.00" required/>
                </div>
                <div class="form__group">
                    <label for="room_name">Account Number</label>
                    <input type="number" id="room_name" name="account_number" placeholder="7118181" required/>
                </div>
                <div class="form__action">
                  <a class="btn btn--dark" href="{{route('home')}}">Cancel</a>
                  <button class="btn btn--main" type="submit"> Initiate</button>
                </div>
              </form>
            </div>
